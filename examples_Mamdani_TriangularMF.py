...
# --- 1. Definirea Variabilelor și Sistemului (neschimbat) ---
...
risc_var.add_term("scazut", TriangularMF(0, 0, 40))
...
# --- 2. Pregătirea Datelor pentru Ploturi ---

# Calcul Evoluție Feedback
iteratii = 15
...
# --- 3. Crearea Plotului Unificat ---

fig = plt.figure(figsize=(16, 10))
plt.subplots_adjust(hspace=0.4, wspace=0.3)

# Subplot 1: MF Buget Lunar
...
ax3.set_title("MF: Nivel Risc")
ax3.legend()

# Subplot 4: Suprafața de Decizie 3D (Ocupă 2 coloane)
...
plt.suptitle("Analiza Sistemului Fuzzy Mamdani - Control Risc Bugetar", fontsize=16)
plt.show()